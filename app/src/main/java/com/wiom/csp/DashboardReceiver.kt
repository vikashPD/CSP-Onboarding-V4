    ...
    override fun onReceive(context: Context, intent: Intent) {
        when (intent.action) {
            ...
            "com.wiom.csp.RESET" -> {
                ...
                OnboardingState.dashboardNavTarget = -2 // go to pitch
            }
            ...
            // Navigate to KYC sub-stage (0=PAN, 1=Aadhaar, 2=GST)
            "com.wiom.csp.KYCSUB" -> {
                val sub = intent.getIntExtra("sub", 0)
                OnboardingState.kycSubStage = sub.coerceIn(0, 2)
                OnboardingState.goTo(5) // Navigate to KYC screen
            }
